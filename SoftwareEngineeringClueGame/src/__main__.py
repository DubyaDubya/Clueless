...
def main():
    ...
    while not win:
        ...
        win = masterPlayersListObject.playerTurn(nickname, playersList, secretDeck, membersIdList, nicknamesList, suggestion, playerPoints, playersDeck, option_table, suspects, weapon, room_table, rooms, newGameObject)
        nickname = next(iter_nickname)
    newGameObject.broadcastUpdates(playersList, "\nThanks for playing.")
    try:
